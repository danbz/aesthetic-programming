...
[^aimoji]: This is demonstrated in the case of *Aimji: AI-Generated Emoji* that uses deep learning (a Deep Convolutional Generative Adversarial Network) to mess up the reductive representational logic of emojis (as explored in chapter 2). See https://process.studio/works/aimoji-ai-generated-emoji/.
