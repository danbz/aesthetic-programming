...
With these ideas in mind, the next section will introduce the sample code for a customizable *Like* button in order to demonstrate the potential of simple interactions like button-press, and how you might begin to consider how the like button becomes a "social button"" and how this creates economic value[^helmond] via computational processes for specific ends. As with previous chapters we will work through the examples and then see where this takes up in terms of reflecting on the wider implications.
