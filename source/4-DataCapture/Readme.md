...
It would be worth checking back (to Chapter 2 — VariableGeometry) for a reminder of how facial recognition identifies a person's face fron the geometry of a face such as the distance between a person's eyes to establish a facial signature tbat is comparable to a standardised database of known faces. Prejudice is thus already built in. 
...
- James Charlton, [Add to Shopping Basket](http://www.aprja.net/add-to-shopping-basket/). *APRJA* 4.1. (2015). 
