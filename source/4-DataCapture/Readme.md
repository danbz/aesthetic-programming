...
Look back at Chapter 2 — Variable Geometry for a reminder of the significance of how facial recognition identifies a person's face fron standardised datasets. It uses the geometry of a face such as the distance between a person's eyes and the distance from their forehead to their chin to establish a facial signature tbat is comparable to a database of known faces. But what is known is based on inherent prejudices.
...
That even sleep is datafied seems to point to the extent to which our subjectivities have been captured too. We produce, share, collect, archive, use and misuse, knowingly or not, massive amounts of data, but what does its capture do to us? What are the inter-subjective relations between data-commodity and human subjects? As we have discussed in this chapter our personal and professional lives seem to be fully enmeshed in various processes of *datafication* — to refer to how data is subsequently transferred into information as a new form of value — but does this simply mean that we are trapped in a prison-house of data? In this last section we will try to unpack these ideas a little more and in particular the idea of value in the context of the flow of data that we call big data and our place within these datafied structures. 

In 2015, transmediale, an annual festival for art and digital culture in Berlin, posted an open call addressing culture's pervasive logic of *Capture All* and the quantificaton of life, work and play. This included some questions worth repeating here: "Are there still modes of being that resist the imperative of digital capitalism to CAPTURE ALL or is there no option but to play along? If so, are there artistic strategies and speculative approaches that do not play this game of quantification by the numbers? What are the blind spots and gaps of relentless quantification and gamification that can be exploited in order to carve out new ways of living?"[^transmediale] Hopefully the practical tasks and examples in this chapter go some way to point to alternative scenarios here. 

On a more abstract level, Marxist theory can help us make sense of this too. The various techniques we have described can be understood means of production, what Marx would refer to as 'fixed capital'. The value comes inasmuch as this can be turned into 'exchange value', in other words how things can become monetised. To see this as simply the labour of users being captured and associated value stolen misses the point, as Tiziana Terranova states in "Red Stack Attack!".[^Terranova] Rather than individual users needing recompensation for their supply of data and free labour, it is the larger social aspect that needs to be considered: "Contrary to some variants of Marxism whuch tend to indentify technology completely with 'dead labour', 'fixed capital' or 'instrumental rationality', and hence with control and capture, it seems important to remember how, for Marx, the evolution of machinery also indexes a level of development of productive powers that are unleashed but never totally contained by the capitalist economy."[^Terranova2] We can find evidence of this in the social energies of the free and open source movement for instance where compensation operates at the level of social  relationships. 

This line of argument also serves to open up questions around the social relation. The politics of this is especially important if we are to develop a position different from the logic of 'capture all' and look to more hopeful readings. Referring to button pressing, Terranova describes the social relation as an asymmetrical relation between two poles — one ractive and the other receptive. She is thinking of actions such as "liking and being liked, writing and reading, looking and being looked at, tagging and being tagged", as examples of the passage from the individual to the collective. She considers how "these actions become discrete technical objects (like buttons, comment boxes, tags etc) which are then linked to underlying data structures [...]" and in turn, how these actions express the possibility of being able to experiment with processes of *individuation* and *transindividuation*, thus the possibility of social transformation itself. 

This is a reference to the philosophy of Gilbert Simondon, to the transformational process by which individuation — how a person or thing is identified as distinguished from other persons or things — is caught up with other individuations. There is no space (or need) to go into this in detail in this publication but for now it is worth simply saying that *transindividuation* describes this passage between the individual 'I' and collective 'We' and how they are transformed through one another.[^Stiegler] We hope something of this happens with this book project, already a collective endeavour, but also one that opens up further possibilities to produce new versions and socialities. Of course this involves tinkering with the underlying codes and values associated with data capture and our ability to reinvent its main purpose. This is an open invitation.    
