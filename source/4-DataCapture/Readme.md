...
Don't make the mistake of taking things at face value. Look back at Chapter ///////////////////// 
...
That even sleep is datafied seems to point to the extent to which our subjectivities have been captured too. But it's not quite that simple thankfully. As we have discussed in this chapter our personal and professional lives seem to be fully enmeshed in various processes of *datafication*: how data is subsequently transferred into information as a new form of value. In this last section we will try to unpack this a little more and in particular the idea of value in the context of the flow of data that we call 'big data' and our place within these datafied structures. 

In 2015, transmediale, an annual festival for art and digital culture in Berlin, posted a call addressing culture's pervasive logic of *Capture All* and the quantificaton of life, work and play. The call included some questions worth repetaing here: "Are there still modes of being that resist the imperative of digital capitalism to CAPTURE ALL or is there no option but to play along? If so, are there artistic strategies and speculative approaches that do not play this game of quantification by the numbers? What are the blind spots and gaps of relentless quantification and gamification that can be exploited in order to carve out new ways of living?"[^transmediale] Hopefully the practical tasks and examples of this chapter go some way to point to alternative scenarios here. 
...
This line of argument also serves to emphasise how larger infrastructures relate to the social relation. The politics of this is especially important if we are to develop a position different from 'capture all' and look to more hopeful readings. Referring to button pressing, Terranova describes the social relation as an asymmetrical relation between two poles — one ractive and the other receptive. She is thinking of actions such as "liking and being liked, writing and reading, looking and being looked at, tagging and being tagged", as examples of the passage from the individual to the collective. She considers how "these actions become discrete technical objects (like buttons, comment boxes, tags etc) which are then linked to underlying data structures [...]" and in turn, how these actions express the possibility of being able to experiment with processes of individuation and transindividuation, thus the possibility of social transformation itself. Of course this involves tinkering with the underlying values associated with data capture and our ability to reinvent its purpose.    
...
This resonates with the field of data visualisation, and Edward Tufte’s belief that the data should be allowed to speak for itself.[^Tufte] His guidelines for information graphics argued for the removal of unnecessary graphical information but relies on the mistaken idea that that somehow data should simply be allowed to speak for itself rather than be lost in the ornamentation of visualisationYet of course data is not raw and unmediated, as unstructured data is selected, targeted, preprocessed and cleaned, mined, and so on, not least to make it human readable. Data begins relatively raw and uninterpreted, but in practice there is always some additional information about its composition, usually derived from the means by which it was gathered in the first place.
