...
### 4.9.2 Form elements
Each form elements like a dropdown menu and a button signals different affordances. Researcher Rena Bivens did a thorough analysis of Facebook's registration page in relation to the gender options available.[^Bivens] When Facebook was first launched in 2004 there was no gender field, but things changed in 2008 when a drop-down list was introduced that included only Male and Female, further changed with the use of radio buttons to emphasize binary options. The breakthrough was in 2014 when Facebook allowed users to customize the gender field and one can now select from a list of more than 50 custom gender options. According to Facebook, they wanted to enhance "personalized experiences" with "authetic identity",[^Facebook2] but it remains arguable whether such specific personalization (not only in the case of Facebook but broader society) actually serves to enforce gender divisions, and of course is ultimately in place for market segmentation (dividing users into ever more sub-groups).  

### 4.9.3 Metrics of likes 
The use of a single like button and the six emoticons was launched in 2016 by Facebook including *Like*, *Love*, *Haha*, *Wow*, *Sad* and *Angry*. All clicks are *categorized* into emotional metrics, displayed publicly on the web, and used for algorithmic calculation to prioritize feeds to users. Again it is fairly clear how the clicks serve the interests of platform owners, and as if to prove the point, Facebook and Instagram have tested the idea of hiding the metrics on posts in order to shift attention to what they simply call "connecting people"[^Hide] — as if were simply altruistic. This practice of quantification is something the artist Benjamin Grosser has parodied in his *Demetricator* series,[^Grosser] first published in 2012, in which all the numbers associated with the metadata has disappeared. The associated *value* of numbers associated with notifications, replies, favorites and feeds, has all been nullified. Or rather it becomes clear that the clicking produces *value* and the proof of this is conspicuous by its absence. 

Tracking is big business and comes with its own invisibility cloak. In 2013, Facebook conducted a research project about last-minute self-censorship,[^Facebook3] revealing their capability of being able to track unposted status updates/posts/comments, including erased text or images. This implies that Facebook is not only interested in capturing what you have posted but what you have been thinking about posting. 

### 4.9.4 Voice and audio data 
So-called smart devices like our computers, phones and other gadgets are commonly equiped with the feature of voice recognition — as, for instance, through Siri, Google Assistant or Alexa — turning an audio input into a command for software processing, and feedback with "more personalised experiences" to assist in the delivery of everyday tasks. You can find these voice assistants in just about everything now — including, everyday objects like a microwave — and they become more and more conversational and intelligent with machine learning improvements. But it's another good example of duplicity, as they can carry out simple tasks very well and become accustomed to your voice, and at the same time are used to capture voices for machine learning applications more widely. In the internet of things, the device serves you and you serve it.     
