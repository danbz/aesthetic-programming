...
[^almoji]: The project employs a machine learning algorithm and use the dataset of 3145 existing emojis as the input data to generate various emoji patterns. See project: https://process.studio/works/aimoji-ai-generated-emoji/
