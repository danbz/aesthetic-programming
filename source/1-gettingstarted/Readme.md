...
5. Click on the folder 'empty-example', and then you will see a list of files and that will be the way to begin:
...
### 1.2.2 Code editor 
ATOM is used as the key code editor in this book. IN keeping with its free and open source credentials, ATOM supports cross-platform editing which can be run on Mac OS, Windows and Linux. 
