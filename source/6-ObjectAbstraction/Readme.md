...
For classroom teaching purpose, we have created a much simplier version[^tofu2] of the moving tofus (just simple squares) aiming to walkthrough the class-object creation in a live coding environment by using these 6 steps guidelines.
