...
To que(e)ry data in this way throws into further question how data is collected, stored, analyzed, recommended, ranked, selected and curated in order to understand the broader social and political implications, not least how categorizations such as gender are normalized. To query the power structures of materials in this way is to understand "the mechanisms that shape reality"[^feminist] and how they might be reorganized into forms that are more queer. 
...
- Design a program that utilizes at least one web API (think about what you want to say conceptually), including:
    ...
    - Decideing which data fields you want to choose to explore and experiment with
...
[^Pasquinelli]: Matteo Pasquinelli, "Google’s PageRank Algorithm: A Diagram of the Cognitive Capitalism and the Rentier of the Common Intellect", in Konrad Becker and Felix Stalder, eds., *Deep Search: The Politics of Search Beyond Google* (London: Transaction Publishers: 2009).

[^Rouvroy]: In Rouvroy's lecture "Algorithmic Governmentalities and the End(s) of Critique" at the Institute for Network Cultures (October 2013) she describes how critique is not possible without access to a fuller understanding of how knowledge is being produced. 
