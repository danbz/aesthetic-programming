...
After the brief example of modeling the person-object, we now move to our central example for this chapter that is inspired by the game [Tofu Go!](https://www.dbdbking.com/Tofu-Go), a game developed and designed by Francis Lam (HK/CN).[^francis] When Tofu becomes a computational object, as in *Tofu Go!*, abstraction is required to capture the complexity of processes and relations, and to represent essential and desired properties and behaviours. In the game, Tofu is designed as a white 3-D cube form with an emoticon, and it can also move and jump. Of course in the real world Tofu cannot behave in that way, but one can imgine how objects can be performed differently when you program your own software, and if you love Tofu as Lam does. "Tofu Go! is a game dedicated to my love for tofu" as he confirms. 
