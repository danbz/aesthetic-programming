...
## References:
- Chun, Wendy. *Programmed Visions*. Cambridge, Mass.: MIT Press, 2011.
- Cox, Geoff, and Alex McLean. *Speaking Code*. Cambridge, Mass.: MIT Press, 2013. ??.
...
<a name="myfootnote4">4</a>: At the same time, you can also find a lot of free and open source fonts to download on the Internet. See, for instance, https://www.1001freefonts.com/.

<a name="myfootnote5">5</a>: Chun, (2013, 45).

<a name="myfootnote6">6</a>: Karen Barad,  2007.

<a name="myfootnote7">7</a>: Sadie Plant, Zeros + Ones: Digital Women and the New Technoculture (London: Forth Estate, 1997), 34-35.

<a name="myfootnote8">8</a>: Plant, Zeros + Ones, 88. 

<a name="myfootnote9">9</a>: For a more detailed version of historical events, see Andrew Hodges's *Alan Turing: The Enigma*. 

<a name="myfootnote10">10</a>: Plant, Zeros + Ones, 98-9, referring to ///from *Discipline and Punish*).

<a name="myfootnote11">11</a>: Here we move from the reductive binary of male-female to another, testosterone-oestrogen.  

<a name="myfootnote12">12</a>: Plant, Zeros + Ones, 102.
