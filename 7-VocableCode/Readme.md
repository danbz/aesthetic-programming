...
<a name="myfootnote1">1</a>: Here we make reference to John Langshaw Austin's *How To Do Things With Words* and in turn to Geoff Cox and Alex McLean's *Speaking Code* (Cambridge, Mass.: MIT Press 2013). 
...
<a name="myfootnote3">3</a>: For a more detailed version of historical events, see Andrew Hodges's *Alan Turing: The Enigma*. 

<a name="myfootnote4">4</a>: Here we move from one binary (male-female) to another (testosterone-oestrogen).  
