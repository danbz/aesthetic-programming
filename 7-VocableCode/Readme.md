...
To conclude this chapter, through exploring the making of *Vocable Code* with its strange syntax (such as notFalse and notTrue) and its many repetitive decimals, we seek to queer these binary relations altogether and foreground the simple idea that: Queer is... making binaries strange.   
