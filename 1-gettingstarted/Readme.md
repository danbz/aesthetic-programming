...
<a name="myfootnote8">8</a>: Seong-Won Lee and Soo-Mook Moon. 2011. Selective just-in-time compilation for client-side mobile javascript engine. In *Proceedings of the 14th international conference on Compilers, architectures and synthesis for embedded systems (CASES '11)*. ACM, New York, NY, USA, 5-14. DOI: https://doi.org/10.1145/2038698.2038703 

who as a software enginner at Mozilla, explaining the details on how Firefox renders high-level dynamic languages like Javascript, the Just-In-Time (JIT) Javascript engine: https://hacks.mozilla.org/2009/07/tracemonkey-overview/

<a name="myfootnote9">9</a>: Lin Clark who works at Mozilla and turn code into code cartoons, and she explains how javascript is run in the browser, see: https://hacks.mozilla.org/2017/02/a-crash-course-in-just-in-time-jit-compilers/. 
